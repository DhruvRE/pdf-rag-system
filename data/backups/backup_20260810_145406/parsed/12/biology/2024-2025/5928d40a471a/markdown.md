...
1
3
A sample of normal double-stranded DNA was found to have thymine
...
<!-- PAGE 2 START -->
4
Observe the schematic diagram that depicts a small section of nucleic
...
1
5
Suresh and Rajesh have defective haemoglobin due to genetic disorders.
...
1
7
Which of the following features shows the mechanism of sex
...
1
8
The following diagram shows a fragment of DNA which is going to be
...
<!-- PAGE 4 START -->
11
Eco R1 cuts the DNA between bases G and A only when the sequence
...
1
12
During the secondary treatment of sewage, which of the following change
...
1
15
Assertion (A): A floating cover placed over the slurry in a biogas plant
keeps on rising.
Reason (R): This cover keeps on rising due to the gas produced in the
tank by the microbial activity.
1
16
Assertion (A): DNA fragments can be isolated by Gel electrophoresis on
...
<!-- PAGE 5 START -->
(ii)
If a blood test reported positive for hCG in a person, then which
other hormones would also be secreted by the tissue secreting
hCG?
OR
B.
(i)
The human male ejaculates about 200 to 300 million sperm
...
<!-- PAGE 6 START -->
19
Given below is the relationship between the HIV levels in the blood and
...
2
20
A culture plate of Lactobacillus shows blue-coloured colonies and
...
B.
(i)
Assume that, GPP Forest A = GPP Forest B = GPP Forest C,
...
reason.
(ii)
Draw an ecological pyramid of number of the following food
chains
...
Section - C
22
The image below shows two germinated seeds X and Y which belong to
...
Embryo sac(s)
iii)
Ovules in this seed’s ovary
B. How multiples embryos are formed in citrus fruits?
C. What advantage will plants developed from seed Y have over seed
X?
3
23
Name the place in human ovary where the first meiotic division is
...
<!-- PAGE 8 START -->
24
The schematic representation given below shows the concept of Central
Dogma.
...
3
25
Describe the steps involved in Southern blot hybridization using
radiolabeled VNTR as a probe.
3
26
Bio-fertilisers are organisms that enrich the nutrient quality in the soil.
Explain the role of three main sources of  bio-fertilisers.
3
27
Explain how PCR technique can be used for amplification of a small
amount of DNA template.
3
28
A. Diagram given below depicts different species of Warbler birds
...
Section - D
29
Assuming that within a population of beetles where Hardy Weinberg
...
4
30
Given below is the pattern of temperature in a person suffering from a
