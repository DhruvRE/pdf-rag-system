...
MARKS
1
According to Coulomb's law, which is the correct relation for the
following figure?
(i) q1 q2> 0
(ii) q1 q2<0
(iii) q1 q2 =0
...
1
2
The electric potential on the axis of an electric dipole at a distance
...
<!-- PAGE 2 START -->
3
The temperature (T) dependence of resistivity of materials A and
...
1
4
Two concentric and coplanar circular loops P and Q have their
...
1
5
A long straight wire of circular cross section of radius a carries a
...
1
6
If the magnetizing field on a ferromagnetic material is increased,
its permeability
(i) decreases
(ii) increases
...
<!-- PAGE 3 START -->
7
An iron cored coil is connected in series with an electric bulb with
...
1
8
Which of the following statement is NOT true about the properties
...
<!-- PAGE 4 START -->
10
In a Young’s double slit experiment, the path difference at a certain
...
1
11
The work function for a metal surface is 4.14 eV. The threshold
...
1
13
Which of the following statements about nuclear forces is not
true?
...
1
14
If the reading of the voltmeter V1 is 40 V, then  the reading of
voltmeter V2 is
1
<!-- PAGE 4 END -->
...
15
The electric potential V as a function of distance X is shown in the
figure.
...
semiconductor.
17
Two statements are given-one labelled  Assertion (A) and the
...
(D) of the screen from the coherent sources both are reduced to 1/3rd,
...
(iii)
λ3 is used to improve visibility in runways during fog and mist
conditions.
...
<!-- PAGE 8 START -->
23
The figure shows a piece of pure semiconductor S in series with a
...
26
Two long straight parallel conductors carrying currents I1 and I2 are
...
## 27.
The magnetic field through a circular loop of wire, 12cm in radius and
...
3
28
An a.c. source generating a voltage ε = ε0 sin ωt is connected to a
...
the applied voltage by a phase angle of
2
. Also draw graphs of V and
i versus t for the circuit.
3
29
Radiation of frequency 1015 Hz is incident on three photosensitive
...
30
The ground state energy of hydrogen atom is -13.6 eV. The photon
...
31
(a)Draw equipotential surfaces for (i)an electric dipole and (ii) two
...
32
(a) Explain the term drift velocity of electrons in a conductor .Hence
obtain the expression for the current through a conductor in terms
of drift velocity.
(b)  Two cells of emfs E1 and E2 and internal resistances 𝑟ଵand 𝑟ଶ
...
5
33
a) Draw the graph showing intensity distribution of fringes with
...
<!-- PAGE 12 START -->
triangular prism of refracting angle 600 as shown in figure.
The prism is made of a transparent material of refractive
index
ଶ
√ଷ . Trace the path of the ray as it passes through
